...
console.log(`The array is ${arr} and the last item was ${lastItemRemoved}`)
////////// PROBLEM 3 //////////
...
console.log(`Evens array is ${evensArr}`)
...
//Code Here
if(score >= 90)console.log('The Grade is A')
if(score <= 89 && score >= 80 )console.log('The Grade is B')
if(score <= 79 && score >= 70 )console.log('The Grade is C')
if(score <= 69 && score >= 60 )console.log('The Grade is D')
if(score < 60 )console.log('The Grade is F')
...
// Subscripting (accessing values using their index) an array can fail. What happens if you subscript to the 7th element, but there are not 7 
// elements in the array? Let's write some code to check for that. 
// Use an if statement to check the length of the 'myFavoriteNumbers' array. If it's less than 7, log 'There are not enough elements in this array' 
// to the console. If the length is more than 7, reassign the value of 'someNum' to the value of the 7th element in the array. 
// (Hint: how can you make sure that your code works for exactly 7 elements? What index do you use to get the 7th element?)

//Code Here
if(myFavoriteNumbers.length < 7)console.log('There are not enough elements in this array')
